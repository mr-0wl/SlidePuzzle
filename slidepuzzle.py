...
def main():
    ...
    while True: #main loop
        ...
        msg = 'Click tile or press arrow keys to slide.' #message to show in upper corner
...
def getRandomMove(board, lastMove=None):
    # Start with a full lit of all 4 moves
    ...
    # return a randome move from the list of remaining moves
...
def getSpotClicked(board, x, y):
    # From the x & y pixel coords the x & y board coords
...
def drawTile(tilex, tiley, number, adjx=0, adjy=0):
    # Draw a tile at board coords tilex tiley optionally a few
...
def slideAnimation(board, direction, message, animationSpeed):
    # note: this function doe not check if the move is valid
...
def generateNewPuzzle(numSlides):
    ...
    drawBoard(board, '')
    pygame.display.update()
    pygame.time.wait(500) # pause for 500 ms for effect
    lastMove = None
